...
In my last post, [Building a gRPC Server with Rust](https://betterprogramming.pub/building-a-grpc-server-with-rust-be2c52f0860e), I already shared why Rust is interesting and why you should learn Rust. Here is one thing that I want to emphasize from that post:
...
Let’s compile and run the program and make sure that everything is setup properly:
